var Zepto = (function() {
    ...
    return (
      ...
      (z.fragment = function(t, e, n) {
        var i, r, o;
        return (
          A.test(t) && (i = w(T.createElement(RegExp.$1))),
          i ||
            (t.replace && (t = t.replace(k, "<$1></$2>")),
            e === y && (e = P.test(t) && RegExp.$1),
            e in M || (e = "*"),
            ((o = M[e]).innerHTML = "" + t),
            (i = w.each(C.call(o.childNodes), function() {
              o.removeChild(this);
            }))),
          u(n) &&
            ((r = w(i)),
      ...
      (z.init = function(t, e) {
        ...
        if ("string" == typeof t)
          if ("<" == (t = t.trim())[0] && P.test(t))
            (n = z.fragment(t, RegExp.$1, e)), (t = null);
          else {
          ...
          if (J(t))
            (i = t),
              (n = j.call(i, function(t) {
                return null != t;
              }));
          else if (r(t)) (n = [t]), (t = null);
          else if (P.test(t))
            (n = z.fragment(t.trim(), RegExp.$1, e)), (t = null);
          else {
            if (e !== y) return w(e).find(t);
            n = z.qsa(T, t);
          }
      ...
      (w.fn = {
        ...
        closest: function(t, e) {
          var n = this[0],
            i = !1;
          for (
            "object" == typeof t && (i = w(t));
            n && !(i ? 0 <= i.indexOf(n) : z.matches(n, t));
  
          )
            n = n !== e && !a(n) && n.parentNode;
          return w(n);
        },
        parents: function(t) {
        ...
        attr: function(e, n) {
          ...
          return "string" != typeof e || 1 in arguments
            ? this.each(function(t) {
                if (1 === this.nodeType)
                  if (r(e)) for (b in e) m(this, b, e[b]);
        ...
        position: function() {
          if (this.length) {
            var t = this[0],
              e = this.offsetParent(),
              n = this.offset(),
              i = U.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
            return (
              (n.top -= parseFloat(w(t).css("margin-top")) || 0),
        ...
        offsetParent: function() {
          return this.map(function() {
            for (
              var t = this.offsetParent || T.body;
              t && !U.test(t.nodeName) && "static" == w(t).css("position");
      ...
      ["after", "prepend", "before", "append"].forEach(function(e, s) {
        ...
        (w.fn[e] = function() {
          var e,
            i,
            r = w.map(arguments, function(t) {
              return "object" == (e = c(t)) || "array" == e || null == t
                ? t
                : z.fragment(t);
            }),
            o = 1 < this.length;
          ...
          (w.fn[a ? e + "To" : "insert" + (s ? "Before" : "After")] = function(
            t
          ) {
    ...
    (function(l) {
        ...
        t.split(/\s/).forEach(function(t) {
          ...
          (n.proxy = function(t) {
            ...
            "addEventListener" in r &&
              r.addEventListener(p(n.e), n.proxy, d(n, c));
        });
      }
          ...
          s(e, t, n, i).forEach(function(t) {
            delete L[o][t.i],
              "removeEventListener" in e &&
                e.removeEventListener(p(t.e), t.proxy, d(t, r));
          });
        });
      }
      function v(i, r) {
      ...
      (l.fn.delegate = function(t, e, n) {
        ...
        (l.fn.trigger = function(t, e) {
          return (
            ((t = x(t) || l.isPlainObject(t) ? l.Event(t) : v(t))._args = e),
            this.each(function() {
    ...
    (function(dh) {
      ...
      (Ch.href = window.location.href),
        ...
        (dh.ajaxJSONP = function(n, i) {
          ...
          return (
            i && i.promise(u),
            dh(a).on("load error", function(t, e) {
              clearTimeout(o),
                dh(a)
                  .off()
                  .remove(),
            ...
            !1 === ih(u, n)
              ...
              : ((window[s] = function() {
                ...
                (a.src = n.url.replace(/\?(.+)=\?/, "?$1=" + s)),
                vh.head.appendChild(a),
                0 < n.timeout &&
      ...
      (t.prototype = {
        ...
        _scrollPage: function() {
          ...
          this.items.forEach(function(n, t) {
            classie.has(n, "shown") ||
              classie.has(n, "animate") ||
              !r(n, i.options.viewportFactor) ||
              setTimeout(function() {
                var t = a() + s() / 2;
                if (
                  ...
                  i.options.minDuration && i.options.maxDuration)
                ) {
                  var e =
                    Math.random() *
        ...
        _checkTotalRendered: function() {
          ++this.itemsRenderedCount,
            this.itemsRenderedCount === this.itemsCount &&
              i.removeEventListener("scroll", this._onScrollFn);
        }
      }),
        (i.AnimOnScroll = t);
    })(window),
                    ...
                    ? ((n = u(this).val()),
                      ...
                      u.each(s, function(t, e) {
                        for (t = 0; t < o.length; t++)
                          void 0 !== e[o[t]] &&
                            -1 !==
                              e[o[t]].toLowerCase().indexOf(n.toLowerCase()) &&
                            (i.push(e), (t = o.length));
                      }),
                      (e = i),
                      c(),
                      a.append(u(r.searchResultsTitle)),
                      e.length
    ...
    (function(t, e) {
      ...
      function(b) {
        ...
        i.animateScroll = function(a, c, t) {
          var e,
            n =
              (e = a ? a.getAttribute("data-options") : null) &&
              "object" == typeof JSON &&
          ...
          var o = function() {
            ...
            (d = 1 < (d = (y += 16) / parseInt(u.speed, 10)) ? 1 : d),
              ...
              (o = h),
              (s = b.pageYOffset),
              (i == r || s == r || b.innerHeight + s >= g) &&
                (clearInterval(o), l.focus(), u.callback(a, c));
          };
        ...
        var o = function(t) {
            var e = (function(t, e) {
              ...
              for (
                "[" === r &&
                1 < (n = (e = e.substr(1, e.length - 2)).split("=")).length &&
                ((i = !0), (n[1] = n[1].replace(/"/g, "").replace(/'/g, "")));
                t && t !== document;
                t = t.parentNode
              ) {
                if ("." === r)
            ...
            e &&
              ...
              (t.preventDefault(), i.animateScroll(e, e.hash, n));
          },
          a = function(t) {
            e ||
        ...
        return (
          (i.destroy = function() {
            n &&
              (b.document.removeEventListener("click", o, !1),
              b.removeEventListener("resize", a, !1),
              (w = s = e = n = null));
          }),
          (i.init = function(t) {
            r &&
              (i.destroy(),
              (n = L(x, t || {})),
              (s = b.document.querySelector(n.selectorHeader)),
              (w = E(s)),
              b.document.addEventListener("click", o, !1),
              s && b.addEventListener("resize", a, !1));
          }),
          i
        );
      }
